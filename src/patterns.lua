...
-- opts.swingAmp, opts.swingFreq, opts.swingPhase : ondulation laterale (sine perpendiculaire)
...
-- Helpers pour ajouter les params couleur a chaque blueprint sans tout dupliquer
...
Patterns.blueprints = {
    ...
    --------------------------------------------- 1. Spiral
    {
        ...
        defaultParams = withColorDefaults(
            { rate = 30, speed = 180, arms = 3, rotSpeed = 1.5 },
            195
        ),
    ...
    --------------------------------------------- 2. Ring
    {
        name = "Ring",
        defaultParams = withColorDefaults(
            { interval = 1.0, count = 24, speed = 200, baseAngle = 0 },
            45
        ),
        paramSpecs = withColorSpecs({
    ...
    --------------------------------------------- 3. Fan oscillant
    {
        name = "Fan oscillant",
        defaultParams = withColorDefaults(
            { rate = 25, speed = 220, count = 5, spread = 1.0, sway = 0.6, swaySpeed = 1.5, baseAngle = math.pi/2 },
            120
        ),
        paramSpecs = withColorSpecs({
            { name = "rate",      min = 1,    max = 200,        step = 1,    label = "Rate (b/s)" },
    ...
    --------------------------------------------- 4. Aimed
    {
        name = "Aimed",
        defaultParams = withColorDefaults(
            { rate = 8, speed = 240, count = 3, spread = 0.3 },
            0
        ),
        paramSpecs = withColorSpecs({
    ...
    --------------------------------------------- 5. Wave (Cave-style sinusoide)
    {
        name = "Wave",
        defaultParams = withColorDefaults(
            { rate = 30, speed = 220, count = 3, spread = 0.6, swingAmp = 60, swingFreq = 6, baseAngle = math.pi/2 },
            260
        ),
        paramSpecs = withColorSpecs({
    ...
    --------------------------------------------- 7. Shotgun (Cave / DonPachi)
    {
        name = "Shotgun",
        defaultParams = withColorDefaults(
            { rate = 3, speed = 280, count = 8, spread = 0.7, aimed = 1 },
            330
        ),
        paramSpecs = withColorSpecs({
    ...
    --------------------------------------------- 8. Petal (multi-fan tournant)
    {
        name = "Petal",
        defaultParams = withColorDefaults(
            { rate = 24, speed = 180, petals = 5, fanCount = 3, fanSpread = 0.4, rotSpeed = 0.8 },
            150
        ),
        paramSpecs = withColorSpecs({
            { name = "rate",      min = 1,   max = 100, step = 1,    label = "Rate (b/s)" },
